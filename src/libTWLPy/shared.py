# "shared.py" from libTWLPy by NinjaCheetah & Contributors
# https://github.com/NinjaCheetah/libTWLPy
#
# This file defines general functions that may be useful in other modules of libTWLPy. Putting them here cuts down on
